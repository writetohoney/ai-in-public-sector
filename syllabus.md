...
- [Artificial Intelligence in the Public Sector](https://www.youtube.com/watch?v=_gpn72cf_U4) (2024) — Information and Privacy Commissioner of Ontario (event video)
...
> **If you read one cover to cover, read *Recoding America*** — it is the public-sector heart of this course.
...
A ~2,500-word briefing note on one or more topics from Sessions 4–9 (procurement, data and harm, responsible AI, the human in the loop). Engage substantively with at least two course readings, apply an explicit tensions lens, and go beyond description to analysis and concrete recommendations.
