...
## Understanding, Governing, and Deploying Artificial Intelligence in Government

**Graduate seminar · 14 sessions**
...
- [Course Schedule, Topics, and Prep Materials](#course-schedule-topics-and-prep-materials)
- [Recommended Readings](#recommended-readings)
- [Assignments, Evaluations, and Grading](#assignments-evaluations-and-grading)
...
**On jurisdiction.** The diagnostic at the heart of this course is jurisdiction-neutral by design — it assesses institutional capacity, not any one country's machinery. The cases and readings deliberately span systems (Canada, the US, the UK, Taiwan, the EU, Australia), and wherever a single-country example is used, students are asked to anchor it to their own jurisdiction. The course has been run with students assessing federal, state or provincial, municipal, and arm's-length public bodies across different countries.
...
**The tensions ledger.** The course throughline, kept as a running log. Each week you record the central trade-off that week's theme forces on government — what is gained, what is risked, and who bears the cost. Three lines is enough. AI does not resolve these tensions; it sharpens them and speeds them up, and the failure mode is letting a tool quietly settle a trade-off that someone should be accountable for. See [`resources/tensions-ledger-template.md`](./resources/tensions-ledger-template.md).
 
**The adaptive capacity diagnostic.** A working instrument runs alongside the ledger, and it is what you take away from the course. In Session 1 you choose a real institution — ideally your own, or one you know well — and across the term you assess it on seven dimensions of adaptive capacity: sensing, self-legibility, absorptive capacity, structural flexibility, acting under uncertainty, feedback and correction, and legitimacy. Seven sessions each carry one dimension. In each you record what evidence you looked at, what you found, what you could not see, the tension the dimension carries, and one intervention that would strengthen it.
 
The two fit together rather than competing: **in the seven diagnostic weeks, the diagnostic entry contains that week's ledger entry**, so there is no duplicated work. The logic is that most of what you learn about AI specifically will date, but the question of whether an institution can see, decide, absorb, and correct at the speed a problem demands will not. AI is the stress test, not the subject. By Session 14 you hold a complete assessment of a real institution — see [`resources/adaptive-capacity-diagnostic.md`](./resources/adaptive-capacity-diagnostic.md) for the full instrument, entry template, and session mapping.
...
## Course Schedule, Topics, and Prep Materials
...
A plain-language, no-code primer on machine learning and large language models: training versus inference, what a model is and is not, the AI lifecycle (development → deployment → monitoring), and where the characteristic failure modes appear. You cannot govern, procure, or evaluate what you do not understand.
 
*Tension: The pull of a powerful new tool versus the duty to understand what you are deploying.*
 
*Discussion: Now that you can see roughly how it works, what claim about AI can you interrogate that you couldn't last week?*
 
**Recommended Material:**
- [Large Language Models, explained](https://www.understandingai.org/p/large-language-models-explained-with) — Lee & Trott
- Video: [What is Machine Learning?](https://vimeo.com/438149588) (Apolitical)
- *Optional / deeper:* [Attention Is All You Need](https://arxiv.org/abs/1706.03762) (2017) — Vaswani et al.
---
...
**The H2+/H2− test.** As you begin assessing, adopt one distinction that runs to the end of the course. Jennifer Pahlka's *Three Horizons* framing separates reform that genuinely builds new capacity (H2+) from reform that, however well-intentioned, relieves the pressure that would otherwise force structural change and so extends the life of a failing system (H2−). The warning matters most for *this instrument*: a capacity diagnostic can itself become an H2− ritual — a better-looking assessment that leaves the operating model untouched, or a maturity score that signals values while changing nothing. Every intervention you propose this term gets one question asked of it: does this build capacity, or relieve the pressure that would force real change? This is the same challenge Vertesi and boyd press in Session 12, arriving early enough to shape how you assess rather than only how you conclude.
 
**Recommended Material:**
- [A Three Horizons Framework for Government Reform](https://www.eatingpolicy.com/p/a-three-horizons-framework-for-government) (2026) — Jennifer Pahlka
- [Generative AI is already widespread in the public sector](https://arxiv.org/pdf/2401.01291) (2024) — Bright et al.
- [The Parable of Google Flu: Traps in Big Data Analysis](https://science.sciencemag.org/content/343/6176/1203.full) (2014) — Lazer et al.
...
*Discussion / Case: How does an AI system actually get approved, funded, and procured in your government? Where could it go wrong? Anchor to a procurement failure students know — e.g. Canada's ArriveCAN, the UK's Post Office Horizon scandal, the US healthcare.gov launch, or a local equivalent.*
...
**Recommended Material:**
- [A Guide to Reforming Information Technology Procurement in the Government of Canada](https://govcanadacontracts.ca/it-procurement-guide/) (2022) — Clarke & Boots. Written for Canada, but the diagnosis of *why* public-sector IT procurement fails travels to any Westminster or federal system.
...
- **One procurement-failure case from your own jurisdiction.** Options: the ArriveCAN report (Auditor General of Canada, 2024); the UK Post Office Horizon Inquiry; the US GAO reports on healthcare.gov; or a documented failure in your system. Read for the pattern, not the country.
---
...
- [Alberta is open-sourcing its AI playbook for government](https://betakit.com/alberta-is-open-sourcing-its-ai-playbook-for-government/) (2026) — BetaKit
- [Digital Public Infrastructure and Public Value: What is public about DPI?](https://www.ucl.ac.uk/bartlett/public-purpose/publications/2024/mar/digital-public-infrastructure-and-public-value-what-public-about-dpi) (2024) — Eaves, Mazzucato & Vazconcellos
- [Responsible AI Pattern Catalogue](https://dl.acm.org/doi/full/10.1145/3626234) (2024) — Lu et al.
---
 
### Session 6 — Data, Automated Decisions & Algorithmic Harm
 
Government data as an asset and a hazard. Administrative, actively-collected, and passively-generated data; automated and algorithmic decision-making; and the characteristic harms — bias, discrimination, exclusion, automation bias — that fall hardest on communities already marginalized by state and society.
 
*Tension: The value of joining and using data versus the harms of surveillance, bias, and exclusion; security versus accessibility.*
 
*Workshop: In small groups, audit an AI-assisted public system and produce a structured critique.*
 
**Recommended Material:**
- [Poverty Lawgorithms](https://datasociety.net/library/poverty-lawgorithms/) (2020) — Michele Gilman
- [Understanding artificial intelligence ethics and safety](https://www.turing.ac.uk/research/publications/understanding-artificial-intelligence-ethics-and-safety) (2019) — David Leslie
- ["F**k the algorithm"?: What the world can learn from the UK's A-level grading fiasco](https://blogs.lse.ac.uk/impactofsocialsciences/2020/08/26/fk-the-algorithm-what-the-world-can-learn-from-the-uks-a-level-grading-fiasco/) (2020) — Daan Kolkman
- [Why we need inclusive data governance in the age of AI](https://www.cigionline.org/articles/why-we-need-inclusive-data-governance-in-the-age-of-ai/) (2024) — Jeni Tennison
---
 
### Session 7 — Reading Week / Project Scoping
**No class**
 
Use this time to catch up on readings, submit any work within the permitted window, and scope your final project. Begin forming teams and identifying a public-sector AI challenge worth a policy intervention or a prototype.
...
- [The Twin Faces of Public Sector Design](https://onlinelibrary.wiley.com/doi/10.1111/gove.12342) (2019) — Clarke & Craft
- [More than a digital system: how AI is changing the role of bureaucrats](https://www.tandfonline.com/doi/full/10.1080/14719037.2022.2095001) (2022) — Giest & Klievink
---
...
- [AI 2027](https://ai-2027.com/) — a frontier scenario, read critically
- [AI in 2025: a gestalt](https://www.gleech.org/ai2025) — a second, contrasting scenario
---
...
*Discussion: For a specific public-sector use case, what is the right regulatory instrument — and who should hold the pen?*
 
**Recommended Material:**
- [Automated compliance and the regulation of AI](https://law-ai.org/automated-compliance-and-the-regulation-of-ai/) — LawAI
- [The governance misspecification problem](https://law-ai.org/the-governance-misspecification-problem/) — LawAI
- [America's AI Action Plan](https://www.whitehouse.gov/wp-content/uploads/2025/07/Americas-AI-Action-Plan.pdf) (2025) — for comparison
---
...
*Discussion: Your team's AI proposal meets the barriers. How do you actually get it through — without cutting the corners that produce the next procurement scandal? And is your proposal H2+ or H2− — does getting it through actually change the operating model, or just relieve pressure on it?*
...
- [Overcoming Barriers to Digital Government: Mapping the Strategies of Digital Champions](https://www.sciencedirect.com/science/article/abs/pii/S0740624X21000903) (2022) — Wilson & Mergel
- *A Civic Technologist's Practice Guide* (2020) — Cyd Harrell, Chapters 10–11
- *Recoding America* (2023) — Jennifer Pahlka, "Conclusion: For and By People"
---
...
These books are referenced throughout the course and will inform your assignments. Copies should be available through your institution's library.
...
| *A Civic Technologist's Practice Guide* | Cyd Harrell (2020) | The craft of doing technology work inside government |
| *Empire of AI* | Karen Hao (2025) | A critical account of the power and industry behind frontier AI |
 
---
 
## Assignments, Evaluations, and Grading
 
The final grade reflects your achievement of the course learning objectives and the criteria listed per assignment below.
 
| Evaluation | Weight | Type | Due |
|---|:---:|---|---|
| Briefing Note 1 | 10% | Individual | After Session 3 |
| Briefing Note 2 | 20% | Individual | After Session 9 |
| Detailed Policy Proposal and/or AI Policy Agent | 25% | Group | Before Session 14 |
| Participation | 20% | Individual | Ongoing |
| Oral Presentation | 25% | Group | Session 14 |
...
A ~1,500-word briefing note on a topic from Sessions 1–3 (AI basics, capabilities, the limits of data). Target audience: a Deputy Minister unfamiliar with the technical details. Explain the topic clearly, identify its key implications for the public sector, and offer preliminary recommendations.
 
**Graded on:** clarity of explanation for a non-technical audience; technical accuracy; policy relevance and actionable framing; professional writing and structure.
 
### Briefing Note 2 (20%)
 
A ~2,500-word briefing note, on one of two routes. **Option A** — one or more topics from Sessions 4–9 (procurement, data and harm, responsible AI, the human in the loop). **Option B** — a note to a senior decision-maker in the institution you have been assessing, on the dimension of adaptive capacity where you judge it weakest, drawing on your five diagnostic entries to date. Either route: engage substantively with at least two course readings, apply an explicit tensions lens, and go beyond description to analysis and concrete recommendations.
 
**Graded on:** quality of argument and analysis; engagement with course materials; realistic, actionable recommendations; how well the central trade-off is surfaced and handled.
 
### Detailed Policy Proposal and/or AI Policy Agent (25%)
 
In groups of three or four, choose one track.
 
**Track A — Policy Intervention Memo.** A ~4,000-word memo addressing a specific AI governance or deployment challenge in the public sector. Must include: problem definition, stakeholder analysis, options analysis (at least three options), a recommended course of action, an implementation roadmap, a risk assessment, and an explicit tensions-and-trade-offs section.
...
A 15–20 minute group presentation of your proposal or prototype to the class and an invited panel.
 
**Graded on:** clarity and structure; quality of argument and evidence; ability to handle Q&A; professional delivery and time management.
 
### Participation (20%)
 
Active engagement in seminar discussion, guest-speaker Q&A, and in-class exercises, plus your weekly tensions-ledger entries and seven adaptive capacity diagnostic entries.
...
This course treats generative AI as a normal part of modern policy work, and you are encouraged to use it. A good workflow is to outline manually, use AI to help develop and pressure-test, then edit, verify, and finalize — with the final steps always human-led. That permission comes with conditions:
 
- **Disclose and cite.** Reference any use of generative AI following the citation guidance for the assignment, and append a short log of your key AI interactions where an assignment requires it.
- **Verify everything.** AI is a drafting and ideation aid, not a source of record. Apply the course AI custom instructions and independently verify every fact, figure, quotation, citation, and claim about current policy. AI frequently fabricates citations; unverified sources are treated as an academic-integrity matter.
- **Keep judgment human.** AI may help you outline and draft, but the analysis, recommendations, and verification must be your own. Work that reads as comprehensively AI-generated may be factored into grading and may prompt a follow-up conversation about your understanding of the assignment.
...
Treat teamwork as you would in a professional organization: contribute proportionally, agree on standards and roles, ensure you can sign off on the entire deliverable as original work, and raise unresolved difficulties with the instructor early. Every member is accountable for the integrity of a group submission.
 
### Guest speakers
 
Guest speakers appear under the Chatham House Rule. Please do not record sessions or attribute comments to named speakers.
...
Please contact the instructor at honey.dacanay@mcmaster.ca.
